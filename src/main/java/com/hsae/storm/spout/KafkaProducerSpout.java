...
public class KafkaProducerSpout extends BaseRichSpout {
	...
	private static final Logger LOG = LoggerFactory.getLogger(KafkaProducerSpout.class);
	...
	public KafkaProducerSpout setZmpSenderAddrs(String zmpSenderAddrs) {
...
//	}
	...
	public void nextTuple() {
		...
		// ArrayList<KeyedMessage<String, byte[]>>();
		...
		LOG.warn("========发送到到kafka的数据条数为：=======" + messages.size());
